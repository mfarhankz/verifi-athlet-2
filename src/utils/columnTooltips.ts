...
export const COLUMN_TOOLTIPS: Record<string, string> = {
  ...
  'V(m)': 'Verified Rating - A single rating that factors in stats like goals, assists, games played, games started, and postseason awards — adjusted for team quality and level of competition — allowing D1, D2, and D3 players to be compared on the same scale. Rated from 50–100, with 100 as the highest possible score.',
  'V(w)': 'Verified Rating -A single rating that factors in stats like goals, assists, games played, games started, and postseason awards — adjusted for team quality and level of competition — allowing D1, D2, and D3 players to be compared on the same scale. Rated from 50–100, with 100 as the highest possible score.'
};
...
const SPORT_SPECIFIC_TOOLTIPS: Record<string, string> = {
  ...
  'V_3': 'Verified Rating -A single rating that factors in stats like goals, assists, games played, games started, and postseason awards — adjusted for team quality and level of competition — allowing D1, D2, and D3 players to be compared on the same scale. Rated from 50–100, with 100 as the highest possible score.',
  'V_4': 'Verified Rating - A single rating that factors in stats like goals, assists, games played, games started, and postseason awards — adjusted for team quality and level of competition — allowing D1, D2, and D3 players to be compared on the same scale. Rated from 50–100, with 100 as the highest possible score.',
  'Verified Rating_3': 'Verified Rating -A single rating that factors in stats like goals, assists, games played, games started, and postseason awards — adjusted for team quality and level of competition — allowing D1, D2, and D3 players to be compared on the same scale. Rated from 50–100, with 100 as the highest possible score.',
  'Verified Rating_4': 'Verified Rating -A single rating that factors in stats like goals, assists, games played, games started, and postseason awards — adjusted for team quality and level of competition — allowing D1, D2, and D3 players to be compared on the same scale. Rated from 50–100, with 100 as the highest possible score.'
};
