...
import { fetchAthleteData, fetchSportColumnConfig, fetchAthleteById } from "@/lib/queries";
...
function PortalContent() {
  ...
  const handleClosePlayerModal = () => {
    ...
    const newUrl = params.toString() ? `/transfers?${params.toString()}` : '/transfers';
    router.push(newUrl);
  };
  ...
  const loadAthleteData = useCallback(async (options: {
    ...
    try {
      ...
      const fetchParams = {
        ...
        sportId: activeCustomer.sport_id,
        dataSource: 'transfer_portal' as 'transfer_portal' | 'all_athletes', // Explicitly set dataSource for transfers page
        displayColumns,
