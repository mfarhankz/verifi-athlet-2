...
export default function Step5({ athlete, surveyData, onComplete, onBack, isSubmitting = false }: Step5Props) {
    ...
    const fetchSchools = async () => {
      try {
        ...
        if (d1SchoolIds && d1SchoolIds.length > 0) {
          const d1Ids = d1SchoolIds.map((item: { school_id: string }) => item.school_id);
        ...
        if (d2SchoolIds && d2SchoolIds.length > 0) {
          const d2Ids = d2SchoolIds.map((item: { school_id: string }) => item.school_id);
        ...
        if (d3SchoolIds && d3SchoolIds.length > 0) {
          const d3Ids = d3SchoolIds.map((item: { school_id: string }) => item.school_id);
        ...
        if (naiaSchoolIds && naiaSchoolIds.length > 0) {
          const naiaIds = naiaSchoolIds.map((item: { school_id: string }) => item.school_id);
  ...
  const handleChange = (dataTypeId: string, value: string | string[]) => {
    ...
    if (dataTypeId === '49') { // Ideal Division
  ...
  return (
    <Flex vertical className="servey-box">
      ...
      <Flex vertical className="items-center">
        <Flex vertical className="mb-5 survey-textarea">
          ...
          <Select
            className="w-full"
            mode="multiple"
            value={formData['49'] ? formData['49'].split(', ').filter((v: string) => v.trim() !== '') : []}
        ...
        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>Looking for full scholarship only</Typography.Title>
          <Select
            className="w-full"
            value={formData['50']}
        ...
        <Flex vertical className="mb-5 survey-textarea">
          ...
          <Select
            ...
            options={[
              ...
              { value: "Very Small: Under 1,000", label: "Very Small: Under 1,000" }
            ]}
        ...
        <Flex vertical className="mb-5 survey-textarea">
          ...
          <Select
            ...
            options={[
              ...
              { value: "Distant Town (small town about an hours drive to a city)", label: "Distant Town (small town about an hours drive to a city)" },
              { value: "Remote Town (small town far from a city)", label: "Remote Town (small town far from a city)" },
              { value: "Fringe Rural (rural area within a short drive to a city)", label: "Fringe Rural (rural area within a short drive to a city)" },
              { value: "Distant Rural (rural area about an hours drive to a city)", label: "Distant Rural (rural area about an hours drive to a city)" },
              { value: "Remote Rural (rural area far from a city)", label: "Remote Rural (rural area far from a city)" }
            ]}
        ...
        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>Playing time vs winning a championship</Typography.Title>
          <Select
            className="w-full"
            value={formData['56']}
        ...
        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>Winning a championship vs location</Typography.Title>
          <Select
            className="w-full"
            value={formData['60']}
        ...
        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>Type of discipline from staff preferred</Typography.Title>
          <Select
            className="w-full"
            value={formData['77']}
        ...
        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>HBCU (Historically Black Colleges and Universities)</Typography.Title>
          <Select
            className="w-full"
            value={formData['64']}
        ...
        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>Do you have a preferred D1 school? If so list here:</Typography.Title>
          <Select
            className="w-full"
            value={formData['66']}
            ...
            options={d1Schools.map(school => ({ value: school.name, label: school.name }))}
            loading={loading}
          />
        </Flex>

        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>Do you have a preferred D2 school? If so list here:</Typography.Title>
          <Select
            className="w-full"
            value={formData['67']}
            ...
            options={d2Schools.map(school => ({ value: school.name, label: school.name }))}
            loading={loading}
          />
        </Flex>

        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>Do you have a preferred D3 school? If so list here:</Typography.Title>
          <Select
            className="w-full"
            value={formData['68']}
            ...
            options={d3Schools.map(school => ({ value: school.name, label: school.name }))}
            loading={loading}
          />
        </Flex>

        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>Do you have a preferred NAIA school? If so list here:</Typography.Title>
          <Select
            className="w-full"
            value={formData['69']}
            ...
            options={naiaSchools.map(school => ({ value: school.name, label: school.name }))}
            loading={loading}
          />
        </Flex>
      ...
      <Flex justify="space-between">
        ...
        <Button onClick={handleSubmit} className="next-servey" loading={isSubmitting} disabled={isSubmitting}>
