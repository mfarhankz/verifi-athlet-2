...
export default function Step4({ athlete, surveyData, onComplete, onBack }: Step4Props) {
    ...
    <Flex vertical className="servey-box">
      ...
      >
        ...
        <Flex vertical justify="center" align="center" className="text-center">
          ...
          <Typography.Text>
            Please indicate how important each factor is in your decision to transfer
          </Typography.Text>
        </Flex>
      </Flex>
      ...
      <Flex vertical className="items-center">
        ...
        <Flex vertical className="mb-5 survey-textarea">
          <Typography.Title level={4}>Ineligible – discipline</Typography.Title>
          <Select
            className="w-full"
            value={formData['44']}
