-- Update RLS policies to include all survey data type IDs
...
-- Create updated SELECT policy with all survey data type IDs
...
-- Create updated INSERT policy with all survey data type IDs
